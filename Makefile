...
SRCS = cub3d.c ft_map_traitement.c ft_map_traitement2.c ft_player_mouvement.c ft_ray_cast.c \
		...
		ft_calloc.c ft_file_traitement.c ft_file_traitement2.c ft_file_traitement3.c ft_graphic.c rad_deg.c \
		ft_memcpy.c ft_memset.c ft_putstr.c ft_screenshot.c ft_split.c ft_strchr.c ft_strjoin.c ft_substr.c ft_ray_cast2.c \
